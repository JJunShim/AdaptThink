...
EXP_NAME="adapt-think-ds1.5b_${train_dataset}_btz${batch_size}_n${n_rollout}_nr${nothinking_ratio}_sl${max_response_length}_fl${adapt_think_max_response_length}_nb${nothinking_bonus}_lb${length_bonus}_lr${LR}_${reward_func}"
